			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<tr>
						...
						<td>${o.orderDate}</td>
						<%
							com.AiWenhao.model.Order o=(com.AiWenhao.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.AiWenhao.dao.UserDao userDao=new com.AiWenhao.dao.UserDao();
						...
						<td class="cart_total">
							<%
								...
								String paymentType=com.AiWenhao.model.Payment.findByPaymentId(con,n);
							%>
